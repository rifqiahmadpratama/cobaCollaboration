...
import styles from '../../assets/styles/recipeUpdate'
...
const RecipeUpdate = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className='text-center mb-5' style={styles.recipeUpdate}>
        <h1 style={styles.h1} className='py-5'>Update Recipe</h1>
        ...
        <div class="mb-3 py-3" style={styles.form}>
          ...
          <div className='py-4 text-center'>
            <button style={styles.send}>Update</button>
          </div>
        </div>
      </div>
      <Footer />
